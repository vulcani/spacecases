...
Make a melee attack using an equipped weapon or fists against an opponent within attack range. Chance to hit is given by the following function: 
```
50% + Melee_Attack_ranks*5% + Brawn*5%	 - enemy dodge modifier
```
This total cannot exceed 95%

If you hit, deal  damage + Brawn/2 (rounded down) or weapon damage + Brawn for weapons wielded with two hands.

Gain a combat maneuver from below. At ranks 1, 4, 6, 8, 9, 10, 11
...
Make a grapple check using fists or a grappling tool against an opponent within attack range. Chance to successfully grapple is given by the following function: 		   (50% + [Skill rank + Brawn] x 5% + # size categories larger x 10% + difference in limbs available x 10%) - enemy dodge modifier.
...
(60% + [Dodge Skill rank + Brawn or Speed + enemy Grapple skill rank – enemy Brawn] x 5% + # size categories larger x 10% + difference in limbs available x 10%)

Note that automatic success or failure is possible here.
...
### Endurance Skills
Physical Resistance No associated combat action
...
### Adrenaline
No associated combat action; cannot be used untrained
...
### Tactician
No primary associated combat action
